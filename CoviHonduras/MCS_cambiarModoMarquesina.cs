...
{
    [TestClass]
    public class MCS_cambiarModoMarquesina : Settingsfields_File
    {
        ...
        [TestMethod]
        public void cambiarModoMarquesina()
        {
            ...
            try
            {
                ...
                takeScreenShot("E:\\workspace\\Maria_Repository\\MCS_application\\attachments\\", "cambiarMarquesinaResults",".jpeg");
                Console.WriteLine(operationWindow + ": " + confirmMessage + " " + ModoMar);
