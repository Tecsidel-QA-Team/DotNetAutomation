...
{
    [TestClass]
    public class MCS_reiniciarvia : Settingsfields_File
    {
        [TestInitialize]
        public void setUp()
        {
        ...
        public void reiniciarVia()
        {
            ...
            try
            {
                ...
                takeScreenShot("E:\\workspace\\Maria_Repository\\MCS_application\\attachments\\","reiniciarViaResults",".jpeg");
