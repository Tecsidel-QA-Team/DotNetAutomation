...
{
    [TestClass]
    public class MCS_cerrarVía : Settingsfields_File
    {
        [TestInitialize]
        public void setUp()
        {
        ...
        public void cerrarVia()
        {
            ...
            try
            {
                ...
                takeScreenShot("E:\\workspace\\Maria_Repository\\MCS_application\\attachments\\", "cerrarViaResults",".jpeg");
