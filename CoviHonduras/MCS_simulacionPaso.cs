...
{
    [TestClass]
    public class MCS_simulacionPaso : Settingsfields_File
    {
        [TestInitialize]
        public void setUp()
        {
        ...
        public void simulaciondePaso()
        {
            ...
            try
            {
                ...
                driver.FindElement(By.LinkText("Simulación de paso")).Click();
                System.Threading.Thread.Sleep(600);
                if (isAlertPresent())
                {
                ...
                takeScreenShot("E:\\Selenium\\","simulacionPasoResults",timet+".jpg");
		        takeScreenShot("E:\\workspace\\Maria_Repository\\MCS_application\\attachments\\","simulacionPasoResults",".jpeg");
